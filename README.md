...
def main():
    ...
    print("FIND THE VALUE OF (X) = FORMUA: f(x) = (ax^2+bx+c)")

    while True:
        print("\n1. Solve a linear equation(ax+b+c)")
        print("\n2. Solve a quadriatic equation (ax^2+bx+c = 0)")
        print("\n3. Evaluate f(x) = ax^ 2+bx+c")
        print("\n4. Find the derivative f'(x) at a point") 
        print("\n5. Wtimate a limit as x approaches a value")
        ...
        print(f"Numeric f '({x}) = {numeric:.6f}(Via central difference)")
            ...
            print("Invalid choice: please coose 1-7")
